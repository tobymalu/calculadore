...
import { Button, View, Text, Switch, TouchableOpacity} from "react-native";
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Home">
        <Stack.Screen name="Colores" component={HomeScreen} />
        <Stack.Screen name="Calculadora" component={DetailsScreen} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
